...
curl -i http://localhost:9080/get -H "Token: <your_jwt_token>"

### 2. Authenticate via Signature (Fallback)
curl -i http://localhost:9080/get -H "username: user123" -H "Timestamp: 1712481600" -H "X-Signature: <calculated_signature>"